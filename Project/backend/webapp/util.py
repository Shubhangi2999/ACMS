...
def predict_program(location,rating,employees,total_sqft,Dpmo):
    ...
    global __locations
    with open("C:/Users/hp/Desktop/ACMS_Main/Project/backend/webapp/artifacts/columns.json", "r") as f:
        __data_columns = json.load(f)['data_columns']
        __locations = __data_columns[5:]
    if __model is None:
        with open('C:/Users/hp/Desktop/ACMS_Main/Project/backend/webapp/artifacts/program_prediction.pickle', 'rb') as f:
