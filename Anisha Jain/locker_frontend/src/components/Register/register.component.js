...
class Register extends Component {
    ...
    validate = () => {
        ...
        if(data.customer==='') errors.customer='Apprx customers are required';
    ...
    render() {
        ...
        return (
                ...
                <FormGroup>
                    <Label for="customer">Number of expected customers per day at your shop?*</Label>
                    <Input id="customer" value={data.customer} invalid={errors.customer ? true : false} name="customer" onChange={this.handleChange} />
